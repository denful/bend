...
| bend-combinator | parsec/fastparse |
|-----|--------|
| `satisfy` | universal parsec term |
| `option` | parsec `option def p` |
| `optional` | standard parser term |
| `choice` | fastparse/parsec term |
| `record` | product-type parser |
| `eachValue` | consistent with `each` |
